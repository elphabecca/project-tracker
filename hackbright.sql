...
COPY grades (id, github, project_title, grade) FROM stdin;
1	jhacks	Markov	10
2	jhacks	Blockly	2
3	sdevelops	Markov	50
4	sdevelops	Blockly	100
5	jhacks	Melons	16
6	sdevelops	Melons	32
\.
...
3	Flask	Create a mad-libs page using Flask	25
4	SQL Quiz	Answer basic questions using SQL	20
5	Melons	Find best salesperson with Ubermelon	7
\.
